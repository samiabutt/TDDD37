...
SELECT "Test 4: Adding a passenger. Expected OK result" as "Message";
...
CALL addPassenger(@a,00000022,"Orch21"); 
CALL addPassenger(@a,00000023,"Orch22"); 
CALL addPassenger(@a,00000024,"Orch23"); 
CALL addPassenger(@a,00000025,"Orch24"); 
CALL addPassenger(@a,00000026,"Orch25"); 
CALL addPassenger(@a,00000027,"Orch26"); 
CALL addPassenger(@a,00000028,"Orch27"); 
CALL addPassenger(@a,00000029,"Orch28"); 
CALL addPassenger(@a,00000030,"Orch29"); 
CALL addPassenger(@a,00000031,"Orch30");
CALL addPassenger(@a,00000032,"Orch31"); 
CALL addPassenger(@a,00000033,"Orch32"); 
CALL addPassenger(@a,00000034,"Orch33"); 
CALL addPassenger(@a,00000035,"Orch34"); 
CALL addPassenger(@a,00000036,"Orch35"); 
CALL addPassenger(@a,00000037,"Orch36"); 
CALL addPassenger(@a,00000038,"Orch37"); 
CALL addPassenger(@a,00000039,"Orch38"); 
CALL addPassenger(@a,00000040,"Orch39"); 
CALL addPassenger(@a,00000041,"Orch40");
